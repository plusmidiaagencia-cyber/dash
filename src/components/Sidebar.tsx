...
const NAV = [
  ...
  { href: "/settings", label: "Configurações", icon: "settings", hint: "Integrações & custos" },
];
  ...
  return (
    <aside className="side">
        ...
        {NAV.map((item) => {
          ...
          return (
            <Link key={item.href} href={item.href} className={`nav-item${active ? " on" : ""}`}>
              <span className="nav-ic">{ICONS[item.icon]}</span>
      ...
      <Link href="/login" className="nav-item nav-foot">
        <span className="nav-ic">{ICONS.logout}</span>
